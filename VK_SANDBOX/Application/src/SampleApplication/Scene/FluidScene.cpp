...
void SampleApplication::FluidScene::Load()
{
...
void SampleApplication::FluidScene::UnLoad()
{
	auto graphicsManager = IHCEngine::Core::GraphicsManagerLocator::GetGraphicsManager();
	auto& graphicsAssetCreator = graphicsManager->GetGraphicsAssetCreator();
...
void SampleApplication::FluidScene::Init()
{
	...
	camera.AddComponent<IHCEngine::Component::ImguiContext_FluidScene>();
...
void SampleApplication::FluidScene::Reset()
{

}

void SampleApplication::FluidScene::createGridMeshAndLoadGridTexture()
{
...
void SampleApplication::FluidScene::createAxisMeshAndLoadAxisTexture()
{
	auto& graphicsAssetCreator = IHCEngine::Core::GraphicsManagerLocator::GetGraphicsManager()->GetGraphicsAssetCreator();
